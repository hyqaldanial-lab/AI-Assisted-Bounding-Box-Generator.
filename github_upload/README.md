...
| Method | Avg. Annotation Time/Image | Segmentation Quality | Model mAP@0.5 |
|---|---|---|---|
| ✍️ Manual Polygon | Slowest | ⭐⭐⭐⭐⭐ Highest | Baseline |
| 🤖 Fully Automated (YOLO+SAM) | Fastest | ⭐⭐⭐ Moderate | Lower |
| 🔀 **Hybrid (Human+SAM)** | **Balanced** | **⭐⭐⭐⭐⭐ Highest** | **Best** |

> The **Hybrid method** achieves manual-level mask quality at near-automated speed, making it the optimal strategy for production-grade dataset creation.
...
> *Results from final trained model (YOLOv11m-seg, 150 epochs, hybrid-annotated dataset)*
...
> 📌 Fill in your actual metric results from `test_final.py` output here.
...
*2217123 | Final Year Project 2025/2026*
